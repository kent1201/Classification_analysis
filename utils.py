...
def Onnx2Torch(onnx_file_path: str) -> str:
...
def GetModel(model_path, model_type="B", mode="cams"):
    ...
    for name, module in model_ft.named_modules():
        ...
        if mode == "cams":
            ...
            if name in ['GlobalAveragePool_6689', 'Flatten_6690', 'Gemm_6691']:
                _set_module(model_ft, name, torch.nn.Identity())
        elif mode == "features":
            if name in ['Gemm_output']:
                _set_module(model_ft, name, torch.nn.Identity())
...
if __name__=='__main__':
    ...
    model_path = r"D:\Users\kentTsai\Documents\models\AoiColorModel_ver2_1\AoiColorModel_ver2_1.onnx"
